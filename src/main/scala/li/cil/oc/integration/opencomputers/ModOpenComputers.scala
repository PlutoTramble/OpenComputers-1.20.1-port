...
object ModOpenComputers extends ModProxy {
  ...
  override def initialize() {
    ...
    blacklistHost(classOf[internal.Adapter],
      ...
      Constants.BlockName.MOTION_SENSOR,
      Constants.BlockName.KEYBOARD,
      Constants.BlockName.SCREEN_TIER_1,
      Constants.BlockName.TRANSPOSER,
      Constants.BlockName.CARPETED_CAPACITOR,
      Constants.ItemName.ANALYZER,
      Constants.ItemName.ANGEL_UPGRADE,
      Constants.ItemName.BATTERY_UPGRADE_TIER_1,
      Constants.ItemName.BATTERY_UPGRADE_TIER_2,
      Constants.ItemName.BATTERY_UPGRADE_TIER_3,
      Constants.ItemName.CHUNKLOADER_UPGRADE,
      Constants.ItemName.CRAFTING_UPGRADE,
      Constants.ItemName.EXPERIENCE_UPGRADE,
      Constants.ItemName.GENERATOR_UPGRADE,
      Constants.ItemName.HOVER_UPGRADE_TIER_1,
      Constants.ItemName.HOVER_UPGRADE_TIER_2,
      Constants.ItemName.INVENTORY_UPGRADE,
      Constants.ItemName.NAVIGATION_UPGRADE,
      Constants.ItemName.PISTON_UPGRADE,
      Constants.ItemName.STICKY_PISTON_UPGRADE,
      Constants.ItemName.SOLAR_GENERATOR_UPGRADE,
      Constants.ItemName.TANK_UPGRADE,
      Constants.ItemName.TRACTOR_BEAM_UPGRADE,
      Constants.ItemName.LEASH_UPGRADE,
      Constants.ItemName.TRADING_UPGRADE)
    blacklistHost(classOf[internal.Drone],
      ...
      Constants.ItemName.NETWORK_CARD,
      Constants.ItemName.REDSTONE_CARD_TIER_1,
      Constants.ItemName.CRAFTING_UPGRADE,
      Constants.ItemName.HOVER_UPGRADE_TIER_1,
      Constants.ItemName.HOVER_UPGRADE_TIER_2)
    blacklistHost(classOf[internal.Microcontroller],
      ...
      Constants.ItemName.ANGEL_UPGRADE,
      Constants.ItemName.CRAFTING_UPGRADE,
      Constants.ItemName.DATABASE_UPGRADE_TIER_1,
      Constants.ItemName.DATABASE_UPGRADE_TIER_2,
      Constants.ItemName.DATABASE_UPGRADE_TIER_3,
      Constants.ItemName.EXPERIENCE_UPGRADE,
      Constants.ItemName.GENERATOR_UPGRADE,
      Constants.ItemName.HOVER_UPGRADE_TIER_1,
      Constants.ItemName.HOVER_UPGRADE_TIER_2,
      Constants.ItemName.INVENTORY_UPGRADE,
      Constants.ItemName.INVENTORY_CONTROLLER_UPGRADE,
      Constants.ItemName.NAVIGATION_UPGRADE,
      Constants.ItemName.TANK_UPGRADE,
      Constants.ItemName.TANK_CONTROLLER_UPGRADE,
      Constants.ItemName.TRACTOR_BEAM_UPGRADE,
      Constants.ItemName.LEASH_UPGRADE,
      Constants.ItemName.TRADING_UPGRADE)
  ...
  def inkCartridgeInkProvider(stack: ItemStack): Int = {
    if (api.Items.get(stack) == api.Items.get(Constants.ItemName.INK_CARTRIDGE))
  ...
  object DefinitionPathProvider extends PathProvider {
    private final val Blacklist = Set(
      ...
      Constants.ItemName.DIAMOND_CHIP,
